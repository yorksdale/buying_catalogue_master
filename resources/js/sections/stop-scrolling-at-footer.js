...
// Usage:
//
//    NHSUK.stopScrollingAtFooter.addEl($(node), $(node).height());
//
...
(function () {
  ...
  var root = this,
      $ = root.jQuery;
  if (typeof root.NHSUK === 'undefined') { root.NHSUK = {}; }
  ...
  var stopScrollingAtFooter = {
    ...
    addEl: function ($fixedEl, height) {
      ...
      $(root).on('nhsuk.pageSizeChanged', stopScrollingAtFooter.updateFooterTop);
    ...
    updateFooterTop: function () {
      ...
      stopScrollingAtFooter.footerTop = footer.offset().top - 50;
    },
  ...
  root.NHSUK.stopScrollingAtFooter = stopScrollingAtFooter;

  $(root).load(function () { $(root).trigger('nhsuk.pageSizeChanged'); });
}).call(this);
